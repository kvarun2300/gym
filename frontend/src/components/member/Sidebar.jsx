...
const NAV_ITEMS = [
  ...
  { to: '/member/payments', label: 'Payments & Invoices', icon: Wallet },
  { to: '/member/workout-plan', label: 'Workout Plan', icon: Dumbbell },
  { to: '/member/diet-plan', label: 'Diet Plan', icon: Salad },
  { to: '/member/progress', label: 'Progress & BMI', icon: LineChart },
];
  ...
  <div className="flex h-full flex-col">
    <div className="flex items-center gap-3 px-5 py-6">
      ...
      <div>
        ...
        <p className="mt-1 font-accent text-[10px] uppercase tracking-wider text-crimson-light">Member Portal</p>
      </div>
    </div>
